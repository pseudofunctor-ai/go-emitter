...
var _ = Describe("LogEmitter", func() {
	It("should log at info", func() {
		...
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "INFO"}, 1, emit.COUNT)
	})
	...
	It("should log at error", func() {
		...
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "ERROR"}, 1, emit.COUNT)
	})
	...
	It("should log at warn", func() {
		...
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "WARN"}, 1, emit.COUNT)
	})
	...
	It("should log at debug", func() {
		...
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "DEBUG"}, 1, emit.COUNT)
	})
	...
	It("should log at trace", func() {
		...
		ctx := context.Background()
		log.EXPECT().DebugContext(ctx, "Hello World!")
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "TRACE"}, 1, emit.COUNT)
	})
	...
	It("should log at fatal", func() {
		...
		ctx := context.Background()
		log.EXPECT().ErrorContext(ctx, "Hello World!")
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "FATAL"}, 1, emit.COUNT)
	})
	...
	It("Should correctly map properties", func() {
		...
		logEmitter.EmitInt(ctx, "test", map[string]interface{}{"_message": "Hello World!", "_logLevel": "INFO", "foo": "bar", "Hello": 1}, 1, emit.COUNT)
	})
